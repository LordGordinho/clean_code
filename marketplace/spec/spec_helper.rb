...
require 'domain/entity/default_freight_calculator'
require 'application/use_case/place_order'
require 'application/use_case/simulate_freight'
require 'application/use_case/validate_coupon'
require 'application/use_case/all_orders'
require 'application/use_case/search_orders'
require 'application/use_case/get_stock'
require 'application/use_case/save_stock'
